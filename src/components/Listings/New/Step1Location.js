...
const Step1Location = ({ formData, updateFormData, onNext, showMap = false }) => {
		...
		>
			...
			>
					...
					<div style={{ marginBottom: "32px", position: "relative" }}>
						...
						>
							{getTranslation(displayLanguage, "listings.addressOfProperty")}
							<span style={{ color: "#FF385C", marginLeft: "4px" }}>*</span>
						</label>
						<input
							ref={inputRef}
							type="text"
